try {
  Install-ChocolateyPackage 'mysql' 'msi' '/passive' 'http://www.mysql.com/get/Downloads/MySQL-5.5/mysql-5.5.25.20120706-win32.msi/from/http://mysql.he.net/' 'http://www.mysql.com/get/Downloads/MySQL-5.5/mysql-5.5.25.20120706-winx64.msi/from/http://mysql.he.net/' 
