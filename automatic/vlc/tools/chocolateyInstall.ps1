Install-ChocolateyPackage 'vlc' 'exe' '/S' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/{{PackageVersion}}/win32/vlc-{{PackageVersion}}-win32.exe' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/{{PackageVersion}}/win64/vlc-{{PackageVersion}}-win64.exe'
