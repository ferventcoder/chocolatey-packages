Install-ChocolateyPackage 'vlc' 'exe' '/S' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/2.1.5/win32/vlc-2.1.5-win32.exe' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/2.1.5/win64/vlc-2.1.5-win64.exe'
