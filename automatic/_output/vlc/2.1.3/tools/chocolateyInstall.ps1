Install-ChocolateyPackage 'vlc' 'exe' '/S' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/2.1.3/win32/vlc-2.1.3-win32.exe' 'http://cdn.mirror.garr.it/mirror3/mirrors/videolan/vlc/2.1.3/win64/vlc-2.1.3-win64.exe'
