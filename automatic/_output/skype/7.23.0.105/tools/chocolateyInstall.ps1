...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.23.0.105.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.23.0.105.msi'
