...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.26.0.101.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.26.0.101.msi'
