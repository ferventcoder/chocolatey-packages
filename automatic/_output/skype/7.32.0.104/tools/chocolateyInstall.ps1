...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'https://download.skype.com/msi/SkypeSetup_7.32.0.104.msi'
...
$url = 'https://download.skype.com/msi/SkypeSetup_7.32.0.104.msi'
