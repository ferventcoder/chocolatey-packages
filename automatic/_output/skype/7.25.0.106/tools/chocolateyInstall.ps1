...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.25.0.106.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.25.0.106.msi'
