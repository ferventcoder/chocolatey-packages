...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.18.0.103.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.18.0.103.msi'
