...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_6.18.0.105.msi'
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/SkypeSetupFull.exe'

$packageName = "skype"
$fileType = "msi"
$silentArgs = "/qn /norestart"
$url = 'http://download.skype.com/msi/SkypeSetup_6.18.0.105.msi'
