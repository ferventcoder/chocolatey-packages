...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.11.0.102.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.11.0.102.msi'
