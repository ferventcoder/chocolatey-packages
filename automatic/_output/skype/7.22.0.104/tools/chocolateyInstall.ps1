...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.22.0.104.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.22.0.104.msi'
