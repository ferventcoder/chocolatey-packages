...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_6.22.64.107.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_6.22.64.107.msi'
