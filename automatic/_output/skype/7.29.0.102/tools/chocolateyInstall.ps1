...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'https://download.skype.com/msi/SkypeSetup_7.29.0.102.msi'
...
$url = 'https://download.skype.com/msi/SkypeSetup_7.29.0.102.msi'
