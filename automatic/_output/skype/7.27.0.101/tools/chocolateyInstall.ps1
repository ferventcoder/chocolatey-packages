...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'https://download.skype.com/msi/SkypeSetup_7.27.0.101.msi'
...
$url = 'https://download.skype.com/msi/SkypeSetup_7.27.0.101.msi'
