...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://www.filehippo.com/download/file/8f8cc994e50cabfb09debca04b1a9ebf374fa2aa8a86641ff2449eab249029f2'
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/SkypeSetupFull.exe'

$packageName = "skype"
$fileType = "msi"
$silentArgs = "/qn /norestart"
$url = "http://download.skype.com/msi/SkypeSetup_6.10.0.104.msi"
