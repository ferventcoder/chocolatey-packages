...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_7.0.0.100.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_7.0.0.100.msi'
