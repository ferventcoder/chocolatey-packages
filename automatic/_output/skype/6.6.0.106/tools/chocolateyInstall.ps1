...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://www.filehippo.com/download/file/ab092c3d0630c9688f85ea63174dc2fcfa4e5c4992a79aedf6b533ba02d2f003'
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/SkypeSetupFull.exe'

$packageName = "skype"
$fileType = "msi"
$silentArgs = "/qn /norestart"
$url = "http://download.skype.com/msi/SkypeSetup_6.6.0.106.msi"
