...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'http://download.skype.com/msi/SkypeSetup_6.22.81.105.msi'
...
$url = 'http://download.skype.com/msi/SkypeSetup_6.22.81.105.msi'
