...
#Install-ChocolateyPackage 'skype' 'exe' '/SILENT /nogoogle /noie /nodesktopicon' 'https://download.skype.com/msi/SkypeSetup_7.37.0.103.msi'
...
$url = 'https://download.skype.com/msi/SkypeSetup_7.37.0.103.msi'
