try {
  ...
  Install-ChocolateyPackage 'gitextensions' 'msi' '/quiet' 'http://sourceforge.net/projects/gitextensions/files/Git%20Extensions/Version%202.48.03/GitExtensions-2.48.03-Setup.msi/download'
