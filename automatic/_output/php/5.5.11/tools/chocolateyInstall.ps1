...
$packageName = 'php' 
$url = 'http://windows.php.net/downloads/releases/php-5.5.11-nts-Win32-VC11-x86.zip' 
$url64 = 'http://windows.php.net/downloads/releases/php-5.5.11-nts-Win32-VC11-x64.zip' 
$validExitCodes = @(0)
