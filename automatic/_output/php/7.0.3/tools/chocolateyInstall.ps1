...
$packageName = 'php'
$url = 'http://windows.php.net/downloads/releases/php-7.0.3-nts-Win32-VC14-x86.zip'
$url64 = 'http://windows.php.net/downloads/releases/php-7.0.3-nts-Win32-VC14-x64.zip'
