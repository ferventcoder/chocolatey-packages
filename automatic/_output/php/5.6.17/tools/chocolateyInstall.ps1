...
$packageName = 'php'
$url = 'http://windows.php.net/downloads/releases/php-5.6.17-nts-Win32-VC11-x86.zip'
$url64 = 'http://windows.php.net/downloads/releases/php-5.6.17-nts-Win32-VC11-x64.zip'
