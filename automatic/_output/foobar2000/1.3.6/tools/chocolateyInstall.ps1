try {
	...
	$url1 = Get-FilenameFromRegex "http://www.filehippo.com/download_foobar2000/history/" 'download_foobar2000/([\d]+)/">Foobar2000 1.3.6<' 'http://www.filehippo.com/download_foobar2000/$1/'
