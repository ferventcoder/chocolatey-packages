try {
  ...
  Install-ChocolateyPackage 'filezilla.server' 'exe' '/S' "https://downloads.sourceforge.net/project/filezilla/FileZilla%20Server/0.9.60/FileZilla_Server-$version.exe"
