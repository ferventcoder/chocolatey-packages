try {
  ...
  Install-ChocolateyPackage 'filezilla.server' 'exe' '/S' "http://downloads.sourceforge.net/project/filezilla/FileZilla%20Server/0.9.56.1/FileZilla_Server-$version.exe"
