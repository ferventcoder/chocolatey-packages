try {
  ...
  Install-ChocolateyPackage 'filezilla.server' 'exe' '/S' "http://downloads.sourceforge.net/project/filezilla/FileZilla%20Server/0.9.47/FileZilla_Server-$version.exe"
