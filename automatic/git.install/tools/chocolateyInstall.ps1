try {
  Install-ChocolateyPackage 'git.install' 'exe' '/VERYSILENT /NORESTART /NOCANCEL /SP- /COMPONENTS="assoc,assoc_sh,ext\reg\shellhere,ext\reg\guihere" /LOG' '{{DownloadUrl}}'
